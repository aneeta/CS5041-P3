...
import Icon, {
  HomeOutlined, MessageOutlined, SettingOutlined
} from '@ant-design/icons';
import { Typography } from 'antd';

const PlantSvg = () => {
  <svg width="1em" height="1em" fill="black" viewBox="0 0 56 56">
...
const PlantLogo = (props) => <Icon component={PlantSvg} {...props} />;
    ...
    <ConfigProvider theme={customTheme}>
      <Layout>
        ...
        <Content className="content-container" >
          <div className='content-innerbox' style={{ padding: 50 }}>
            {/* <Descriptions
            title={props.title}
            style={{
              textAlign: 'right',
