...
def main(plant_number):
    ...
    while True:
        ...
        try:
            ...
            # Log Arduino Message
            print("[Success] Received Server Message sent to Arduino (" + server_json_message + ") at", time.time())
            ...
            try:
                ...
                if(serial_message != b''): # check if actual data
                    ...
                    if serial_message == '0' or serial_message == '1' or serial_message == '2':
                        ...
                        # Log message 
                        print("[Success] Receieved Arduino Message Sent to Server (" + serial_message + ") at", time.time())
